...
extern void __prep_transhuge_page_for_htmm(struct mm_struct *mm,
					   struct page *page);
...
extern void check_base_cooling(pginfo_t *pginfo, struct page *page,
			       bool locked);
extern int set_page_coolstatus(struct page *page, pte_t *pte,
			       struct mm_struct *mm);
...
extern bool check_split_huge_page(struct mem_cgroup *memcg, struct page *meta,
				  bool hot);
extern bool move_page_to_deferred_split_queue(struct mem_cgroup *memcg,
					      struct page *page);
...
extern unsigned long get_nr_lru_pages_node(struct mem_cgroup *memcg,
					   pg_data_t *pgdat);
